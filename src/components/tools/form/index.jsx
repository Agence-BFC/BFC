  ...
  return (
    <form className="contain-blue flex flex-col items-center lg:w-3/4 text-black" action="" method="POST">
      ...
      <input
        ...
        required
      />
      <label htmlFor="" className="text-black pl-2 pt-4">Téléphone:</label>
      <input className="border border-black rounded-full w-3/5" type="text" />
      <label htmlFor="" className="text-black pl-2 pt-4">Objet:</label>
      <input className="border border-black rounded-full w-3/5" type="text" />
      <label htmlFor="" className="text-blackpl-2 pt-4">Message*:</label>
      <textarea
